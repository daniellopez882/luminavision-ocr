...
**Created by Daniel Lopez (@daniellopez882)**

LuminaVision OCR is a fast and efficient document layout detection and text extraction tool using YOLO object detection and multiple OCR backends.
...
```bash
git clone https://github.com/daniellopez882/luminavision-ocr
cd luminavision-ocr
conda env create -f environment.yml
conda activate luminavision
